...
<div class="wrapper">
	...
	<div class="top_gnb_area">
	 ...
	 <div class="content_subject"><span>회원가입</span></div> 
			...
			<div class="id_wrap">
				...
				<span class="final_id_ck">아이디는 한글,영문,숫자로만 2글자 이상 12글자 이하로 입력해주세요.</span>
			</div>
			...
			<div class="pw_wrap">
				...
				<span class="final_pw_ck">비밀번호는 한글,영문,숫자로만 2글자 이상 12글자 이하로 입력해주세요.</span>
			</div>
			<div class="pwck_wrap">
			...
			<div class="user_wrap">
				...
				<span class="final_name_ck">이름은 한글,영문,숫자로만 2글자 이상 12글자 이하로 입력해주세요.</span>
			</div>
			<div class="mail_wrap">
...
//var idForm = /^[a-zA-Z0-9가-힣ㄱ-ㅎ]{2,12}$/;
...
$(".mail_check_button").click(function(){
    ...
    if(mailFormCheck(email)){
        warnMsg.html("이메일이 전송되었습니다. 이메일을 확인해 주세요..");
...
/*  function idFormCheck(id) {
	var idForm = /^[a-zA-Z0-9가-힣ㄱ-ㅎ]{2,12}$/;
	return idForm.test(id);
} */

//	입력 비밀번호 형식 유효성 검사
 function pwFormCheck(pw) {
		 var pwForm = /^[a-zA-Z0-9가-힣ㄱ-ㅎ]{2,12}$/;
		return pwForm.test(pw);
	}
 
// 입력 이름 형식 유효성 검사
 function nameFormCheck(name) {
	 	var nameForm = /^[a-zA-Z0-9가-힣ㄱ-ㅎ]{2,12}$/;
