                ...
                <div class="admin_content_wrap">
                    ...
                    <div class="admin_content_main">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input id="sellerName_input" readonly="readonly" value="${goodsInfo.sellerName }" disabled>
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="makeDate" autocomplete="off" readonly="readonly" value="<c:out value="${goodsInfo.makeDate}"/>" disabled>                    				
                    			</div>
                    		</div>            
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input name="maker" value="<c:out value="${goodsInfo.maker}"/>" disabled>
                    			</div>
                    		</div>             
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content bit">
                    				<textarea name="productIntro" id="productIntro_textarea" disabled>${goodsInfo.productIntro}</textarea>
                    			</div>
                    		</div>        		
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content bct">
                    				<textarea name="productContents" id="productContents_textarea" disabled>${goodsInfo.productContents}</textarea>
                    			</div>
                    		</div>
...
$(document).ready(function(){
	...
	let length = makeDate.indexOf(" ");
	
	makeDate = makeDate.substring(0, length);
	
	$("input[name='makeDate']").attr("value", makeDate);
