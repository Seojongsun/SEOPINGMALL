...
<body>
				...
				<table class="seller_table">
					...
					<c:forEach items="${list}" var="list">
						<tr>
							...
							<td><a class="move" href='<c:out value="${list.sellerId}"/>'>
	...
	<script>
		/*  함수 구현부에 서버에서 전송되는 데이터를 체크 후, 존재 할 시에 판매자 등록 성공 메시지를 알리는 경고창을 띄우는 코드를 추가합니다.*/
		...
		$(".move")
				.on(
						...
						function(e) {
							...
							moveForm
									.append("<input type='hidden' name='sellerId' value='"
											+ $(this).attr("href") + "'>");
