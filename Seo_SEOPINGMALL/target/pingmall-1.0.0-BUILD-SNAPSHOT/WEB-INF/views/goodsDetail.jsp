...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="content_subject"><span>제품정보</span></div>
				...
				<div class="ct_right_area">
					...
					<div class="price">
						...
						<div class="discount_price">
							판매가 : <span class="discount_price_number"><fmt:formatNumber value="${goodsInfo.productPrice - (goodsInfo.productPrice*goodsInfo.productDiscount)}" pattern="#,###원" /></span> 
							[<fmt:formatNumber value="${goodsInfo.productDiscount*100}" pattern="###" />% 
							<fmt:formatNumber value="${goodsInfo.productPrice*goodsInfo.productDiscount}" pattern="#,###원" /> 할인]</div>							
					</div>
			...
			<div class="content_middle">
				...
				<div class="product_intro_title">
					<span><b>info</b> 정보</span>	
				</div>
...
$(document).ready(function(){
	...
	/* makeDate */
	const year = "${goodsInfo.makeDate}";
	
	let tempYear = year.substr(0,10);
	
	let yearArray = tempYear.split("-")
	let makeDate = yearArray[0] + "년 " + yearArray[1] + "월 " + yearArray[2] + "일";
	
	$(".makeDate").html(makeDate);
	
	/* 포인트 삽입 */
	let salePrice = "${goodsInfo.productPrice - (goodsInfo.productPrice*goodsInfo.productDiscount)}"
...
$(".reply_button_wrap").on("click", function(e){
	...
	$.ajax({
		...
		success : function(result){
			...
			if(result === '1'){
				alert("이미 이 상품에 대한 등록된 리뷰가 존재 합니다.")
			} else if(result === '0'){
