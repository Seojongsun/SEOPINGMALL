						...
						<c:forEach items="${cartInfo}" var="ci">
							<tr>
								...
								<td class="td_width_4 price_td">
									...
									적립 마일리지 : <span class="green_color"><fmt:formatNumber value="${ci.point}" pattern="#,###" /></span>
								</td>
							...
							<td>
								<table>
									<tbody>
										<tr>
											<td>
												<strong class="totalPoint_strong">총 적립 예상 마일리지</strong>
											</td>
											<td>
							...
							<td>
								<table>
									<tbody>
										<tr>
											<td>
												<strong class="totalPrice_strong">총 결제 예상 금액</strong>
...
$(".delete_btn").on("click", function(e){
	...
	// const cartId = parseInt($(this).data("cartid"));
