			...
			<div class="content_main">
				...
				<div class="member_info_div">
					<table class="table_text_align_center memberInfo_table">
						<tbody>
							<tr>
								<th style="width: 25%;"><span>주문자</span></th>
								<td style="width: *"><b>이름 :</b> ${memberInfo.memberName} <b>이메일 :</b> ${memberInfo.memberMail}</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<tbody>
				<c:forEach items="${orderList}" var="ol">
					<tr>
						...
						<td class="product_name_td"><b>${ol.productName}</b></td>
						<td class="goods_table_price_td">
							<b>1개당</b> : <fmt:formatNumber value="${ol.salePrice}" pattern="#,###원" /> | <b>수량</b> ${ol.productCount}개
							<br><b>총</b> : <fmt:formatNumber value="${ol.totalPrice}" pattern="#,###원" />
							<br><b>적립 예정 포인트</b> : <fmt:formatNumber value="${ol.totalPoint}" pattern="#,###p" />
		...
		<table class="point_table">
			...
			<tbody>
				<tr>
					<th>사용 가능한 포인트</th>
					<td>
						${memberInfo.point}p <input class="order_point_input" value="0">p 
