...
<link rel="stylesheet" href="../resources/css/admin/sellerPop.css">
<script
...
<body>
               			...
               			<div class="table_exist">
	                    	<table class="seller_table">
	                    		...
	                    		<tr>
	                    			...
	                    			<td>
	                    			<a class="move" href='<c:out value="${list.sellerId}"/>' data-name='<c:out value="${list.sellerName}"/>'>
	                    			<c:out value="${list.sellerName}"></c:out>
	                    			</a>
	                    			</td>
	...
	<script>
		...
		$(".move").on("click", function(e){
			...
			$(opener.document).find("#sellerId_input").val(sellerId);
			$(opener.document).find("#sellerName_input").val(sellerName);
